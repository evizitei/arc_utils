...
/* package ansi-colors-0.1.0.0 */
#ifndef VERSION_ansi_colors
#define VERSION_ansi_colors "0.1.0.0"
#endif /* VERSION_ansi_colors */
#ifndef MIN_VERSION_ansi_colors
#define MIN_VERSION_ansi_colors(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ansi_colors */
...
#define CURRENT_COMPONENT_ID "ansi-colors-0.1.0.0-LdRlhD08FyqGkdGtQuABQk-ansi-colors-exe"
